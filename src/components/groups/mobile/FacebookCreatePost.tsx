        ...
        <div className="flex items-center space-x-3 mb-3">
          ...
          {!isExpanded ? (
            <button
              ...
              className="flex-1 bg-gray-100 hover:bg-gray-200 text-gray-500 text-left px-4 py-3 rounded-full transition-colors duration-200 text-sm sm:text-base min-h-[44px] touch-manipulation"
            >
