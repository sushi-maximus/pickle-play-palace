  ...
  return (
    <>
      ...
      <Button 
        variant="outline"
        size="sm"
        className="mb-6 hover:bg-primary/5 hover:border-primary/30 transition-all duration-200 hover:scale-105"
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2 mt-3">
                  <Badge variant="outline" className="flex items-center hover:bg-primary/5 transition-colors">
